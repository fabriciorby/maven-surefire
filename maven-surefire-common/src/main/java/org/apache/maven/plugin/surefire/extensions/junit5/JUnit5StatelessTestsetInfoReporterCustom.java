...
import org.apache.maven.plugin.surefire.report.ConsoleReporterCustom;
 ...
 * @since 3.0.0-M6
 */
public class JUnit5StatelessTestsetInfoReporterCustom extends JUnit5StatelessTestsetInfoReporter
{
    ...
    {
        return new ConsoleReporterCustom( logger, isUsePhrasedClassNameInRunning(),
